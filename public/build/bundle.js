...
var Zones = function (_Component) {
    ...
    _createClass(Zones, [{
        ...
        value: function componentDidMount() {
            ...
            _superagent2.default.get('/api/zone').query(null) // query string
...
var Zone = function Zone(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "h2",
                { className: "is-size-3 has-text-default" },
                " ",
...
var Comments = function (_Component) {
    ...
    _createClass(Comments, [{
        ...
        value: function componentDidMount() {
            ...
            _superagent2.default.get('/api/comment').query(null) // query string
            .set('Accept', 'application/json').end(function (err, res) {
                if (err) {
                    alert("ERROR WHILE FETCHING " + err);
                }
        ...
        value: function updateUsername(event) {
            ...
            this.setState(function (prevState) {
                return prevState.comment.username = username;
            });
        ...
        value: function updateBody(event) {
            ...
            this.setState(function (prevState) {
                return prevState.comment.body = body;
            });
            console.log(this.state.comment);
        }
    }, {
        key: 'commentOnSubmit',
        value: function commentOnSubmit() {
            var comment = this.state.comment;
            console.log(comment);
            this.setState(function (prevState) {
                return prevState.list.push(comment);
            });
        ...
        key: 'render',
        value: function render() {
            var itemList = this.state.list.map(function (comment, i) {
                return _react2.default.createElement(
                    'div',
                    { key: i },
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                { className: "is-size-3 has-text-default" },
                " ",
                props.currentComment.username,
                " "
            ),
            _react2.default.createElement(
                "span",
                null,
                props.currentComment.body
            )
        )
    );
};
